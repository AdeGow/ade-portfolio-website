  ...
  return (
    <section id="hero">
      <div className="bg-floral dark:bg-jet grid grid-flow-row auto-rows-max md:auto-rows-min md:h-4/5	">
        <div className="container mx-auto text-left mt-32 md:mt-44 px-7 md:px-16">
          <div className="flex items-center">
            <div className="w-full">
              <h1 className="font-title font-semibold text-jet text-5xl mb-5 md:text-7xl dark:text-floral md:mb-4">ADELINE <br className="md:hidden" />DE GAULEJAC</h1>
