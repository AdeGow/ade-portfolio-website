          ...
          <div className="px-4 py-4 h-18">
            ...
            <div className="flex flex-row h-16 justify-around items-center mx-auto px-12 py-2">
              <div className="flex items-center h-full mx-4">
                <a className="h-12" href="https://github.com/giacdc/rails-alibye" target="_blank" rel="noreferrer">
              ...
              {/* Website link */}
              <div className="flex items-center h-full mx-4">
                <a className="h-12" href="https://alibye-adegow.herokuapp.com/" target="_blank" rel="noreferrer">
...
export default AlibyeProjectCard;
