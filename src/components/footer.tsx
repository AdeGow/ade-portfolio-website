...
const Footer: FunctionComponent = () => {
  ...
  const pdfUrl = 'https://drive.google.com/file/d/118LuyXIFqREIZQAZeOi6L5ypaUhPUC_Q/view?usp=sharing';
  ...
  return (
    <div className="pt-10 pb-28 md:pb-6 px-5 md:px-24 flex flex-col bg-floral dark:bg-dark-grey md:flex md:flex-row-reverse md:justify-between">
      ...
      <div className="md:flex md:flex-col md:w-1/3">
        ...
        <div className="flex flex-row justify-center items-center">
          {/* Location icon */}
          <div className="px-3 h-14 w-full flex flex-row items-center md:mb-5 lg:mb-0">
